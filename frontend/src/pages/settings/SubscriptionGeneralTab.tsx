      ...
      },
      {
        ...
        children: (
          <>
            ...
            <SettingListItem
              ...
              description={(
                <>
                  ...
                  <a
                    href="https://github.com/S1MPLE/S1MPLE-PANEL/blob/main/docs/custom-subscription-templates.md"
                    target="_blank"
            ...
            >
              <Input value={allSetting.subThemeDir} placeholder="/etc/S1MPLE-PANEL/sub_templates/my-theme/"
