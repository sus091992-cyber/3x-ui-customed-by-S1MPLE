...
const DONATE_URL = 'https://github.com/S1MPLE';
const DOCS_URL = 'https://github.com/S1MPLE';
const REPO_URL = 'https://github.com/S1MPLE/S1MPLE-PANEL';
    ...
    >
      ...
      >
        <div className="sider-brand">
          <div className="brand-block">
            <span className="brand-text">{railCollapsed ? 'S1' : 'S1MPLE PANEL'}</span>
          </div>
          {!railCollapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">S1MPLE PANEL</span>
          </div>
